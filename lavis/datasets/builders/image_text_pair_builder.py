...
# @registry.register_builder("ccs_14m")
# class CCS14MBuilder(BaseDatasetBuilder):
#     train_dataset_cls = ImageTextPairDataset

#     DATASET_CONFIG_DICT = {
#         "default": "configs/datasets/ccs14m/defaults.yaml"
#     }
...
@registry.register_builder("laion115M")
class Laion115MMultiBuilder(BaseDatasetBuilder):
    train_dataset_cls = LaionDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/laion/laion115m.yaml"}
...
@registry.register_builder("ccs14M")
class CCS14MBuilder(BaseDatasetBuilder):
    train_dataset_cls = LaionDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/laion/ccs14m.yaml"}
