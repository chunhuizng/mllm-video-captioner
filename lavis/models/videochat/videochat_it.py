...
@registry.register_model("videochat_it")
class VideoChat_it(Blip2Base):
    ...
    def from_config(cls, config):
        ...
        # cls.begin_signal = "###"
        # cls.role = ("Human", "Assistant")
        # cls.start_token = config.get("start_token", "<Video>")
        # cls.end_token = config.get("end_token", "</Video>")
        # cls.img_start_token = config.get("img_start_token", "<Image>")
        # cls.img_end_token = config.get("img_end_token", "</Image>")
        # debug
        ...
        model = cls(
            ...
            begin_signal="###",
            role=("Human", "Assistant"),
            start_token=config.get("start_token", "<Video>"),
            end_token=config.get("end_token", "</Video>"),
            img_start_token=config.get("img_start_token", "<Image>"),
            img_end_token=config.get("img_end_token", "</Image>"),
            # debug
            debug=debug
        )
