...
from lavis.models.video_llama.blip2 import Blip2Base, disabled_train
from lavis.models.video_llama.modeling_llama import LlamaForCausalLM
# from video_llama.models.Qformer import BertEncoder
from transformers import LlamaTokenizer,BertConfig
# from transformers.models.bert.modeling_bert import BertEncoder
import einops
import copy
from lavis.models.video_llama.Qformer import BertConfig, BertLMHeadModel
from lavis.models.video_llama.ImageBind.models.imagebind_model import ImageBindModel, ModalityType
from lavis.models.video_llama.ImageBind.models import imagebind_model
...
class VideoLLAMA(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "vicuna_7b": "configs/models/video_llama/video_llama_7b.yaml",
    }
    ...
    def __init__(
        ...
        # # self.audio_encoder.load_state_dict(torch.load("{}/imagebind_huge.pth".format(imagebind_ckpt_path))) #### DO NOT LOAD AUDIO
        # # free vision encoder
    ...
    def generate(
        ...
        with self.maybe_autocast():
            ...
            outputs = self.llama_model.generate(
                ...
                stopping_criteria=stopping_criteria ### stop generation
            )
    ...
    def from_config(cls, cfg):
        ...
        fusion_header_type = cfg.get("fusion_header_type", '')
        ...
        imagebind_ckpt_path = cfg.get("imagebind_ckpt_path", None)
        model = cls(
            vit_model=vit_model,
        ...
        pretrained_filename = cfg.get("pretrained", "")
        if load_pretrained:
